...
const LeadQueueView = () => {
  ...
  const handleTriggerAI = async () => {
    ...
    try {
      ...
      toast.success('AI Call Analysis initiated');
      ...
      toast.error(err.response?.data?.message || 'AI analysis could not be completed.');
      setAiAnalyzing(false);
    }
  };
  ...
  return (
    <div className="space-y-3 max-w-4xl mx-auto pb-24 md:pb-8">
      ...
      <div className="bg-white p-3 md:p-4 rounded-2xl shadow-sm border border-gray-200 space-y-2.5">
        ...
        <div className="grid grid-cols-4 gap-1.5 pt-1.5 border-t border-gray-100">
          <button
            ...
            className={`p-2 rounded-xl text-left transition-all border flex flex-col justify-between h-[58px] ${
      ...
      {/* 2. EMPTY STATE */}
      {!currentLead ? (
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm text-center max-w-md mx-auto my-6 space-y-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-gray-900 hover:bg-black text-white text-xs font-bold rounded-xl transition-colors inline-flex items-center gap-1.5"
          >
            <RefreshCw className="h-3.5 w-3.5" />
            Refresh Queue
          </button>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between bg-white px-3 py-2 rounded-xl border border-gray-200 text-xs font-semibold text-gray-700">
            <button
              ...
              className="px-3 py-1 border rounded-lg hover:bg-gray-50 disabled:opacity-30 text-xs font-bold transition-colors"
            >
              ‹ Prev
            </button>
            <div className="flex items-center gap-1 text-xs">
              <span className="text-gray-400 font-bold uppercase text-[10px]">LEAD</span>
              <span className="font-black text-gray-900 px-2.5 py-0.5 bg-gray-100 rounded-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="bg-gradient-to-b from-blue-100/70 via-indigo-50/40 to-white px-4 pt-6 pb-4 text-center space-y-3">
              ...
              {/* Lead Owner & Lead Stage Pill Selectors (Grid of 2) */}
